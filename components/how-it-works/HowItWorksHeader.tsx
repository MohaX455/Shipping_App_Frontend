                ...
                <div className="max-w-7xl mx-auto">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-base sm:text-lg lg:text-xl text-slate-100 leading-relaxed font-body drop-shadow-md max-w-2xl">
                            Social Shipping connects senders and travelers directly. Learn how our platform brings the right people together at the right time.
                        </p>

                        {/* Decorative Element */}
                        <div className="mt-10 flex items-center gap-2">
                            <div className="w-1 h-12 bg-gradient-to-b from-blue-400 to-transparent rounded" />
                            <span className="text-sm font-semibold text-blue-300 uppercase tracking-widest">Seamless Connection</span>
                        </div>
                    </div>
                </div>
            </div>
