            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center space-y-6">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto font-body">
                        Create your first travel and start earning money on your next trip
                    </p>
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="inline-flex items-center px-8 sm:px-10 py-3 sm:py-4 bg-purple-600 text-white font-semibold text-base sm:text-lg rounded-lg hover:bg-purple-700 transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer font-heading"
                        >
                            Add a Travel
